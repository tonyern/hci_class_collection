...
package edu.ou.cs.hci.assignment.prototyped.fx.pane;
...
import edu.ou.cs.hci.assignment.prototyped.fx.Controller;
import edu.ou.cs.hci.resources.Resources;

//******************************************************************************

/**
 * The <CODE>SettingsPane</CODE> class.
 *
 * @author  Chris Weaver
 * @version %I%, %G%
 */
public final class SettingsPane extends AbstractPane
{
	//**********************************************************************
	...
	private static final String	HINT = "Settings for text editing";
	...
	private Pane	buildPane()
	{
		...
		box.setId("settings-vbox");		// See #settings-vbox in View.css
	...
	private Node	createLabel()
	{
		...
		label.setId("settings-label");			// Style the label using CSS
