...
/**
 * The <CODE>CoverPane</CODE> class.
 *
 * @author  Chris Weaver
 * @version %I%, %G%
 */
public final class CoverPane extends AbstractPane
{
	//**********************************************************************
	...
	private static final String	HINT = "Cover Flow for Movies";
	...
	public CoverPane(Controller controller)
	{
